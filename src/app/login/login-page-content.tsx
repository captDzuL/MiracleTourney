  ...
  return (
    <div className="mx-auto max-w-md rounded-[2rem] border border-white/10 bg-slate-900/70 p-8">
      ...
      <form action={loginAction} className="mt-6 space-y-4">
        ...
        <button type="submit" className="mt-2 w-full rounded-full bg-cyan-400 px-4 py-3 text-sm font-semibold text-slate-950 transition hover:bg-cyan-300">
          {t("submit")}
        </button>
      </form>
      ...
      <p className="mt-6 text-center text-sm text-slate-400">
        ...
        <Link href={(returnTo
          ...
          : eventId
            ...
            : "/register") as never} className="text-cyan-400 hover:text-cyan-300">
          {t("registerHere")}
        </Link>
      </p>
    </div>
