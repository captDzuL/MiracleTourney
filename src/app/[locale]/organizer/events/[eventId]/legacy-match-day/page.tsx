...
export default async function LegacyMatchDay({ params, searchParams }: {
  ...
  return AdminWorkspace({ workspaceScope: "organizer_competition", searchParams: Promise.resolve({ phase: "run", activeEventId: eventId, matchEventId: eventId, matchId: query?.matchId }) });
}
