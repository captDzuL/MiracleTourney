...
import { type AdminPhase, type AdminWorkspaceScope, adminPhases, buildAdminPhaseHref, canUseAdminWorkspace, resolveAdminPhase } from "./admin-flow";
...
export default async function AdminPage({
  ...
  if (!canUseAdminWorkspace(user.role, workspaceScope)) {
  ...
  const actor = { id: user.id, role: user.role as "platform_admin" | "admin" | "organizer" };
