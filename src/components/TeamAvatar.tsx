  ...
  return (
    <span className="inline-flex min-w-0 items-center gap-2">
      ...
      <span className="min-w-0">
        <span className="pv-team-identity__name block truncate font-semibold text-slate-900">{name}</span>
        {meta ? <span className="pv-team-identity__meta block truncate text-xs text-slate-500">{meta}</span> : null}
      </span>
    </span>
  );
}
