...
- Review-round mutation coverage: removed permanent-URL, team, score, certificate-readiness/count, receipt, drain, add-after-await, delete-before-drain, worker, ignore, retry, timeout, and shard-order mutations were all rejected by the static contract.
